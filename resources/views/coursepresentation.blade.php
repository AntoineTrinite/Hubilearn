...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Styles -->
        <link href="../css/coursespresentation.css" rel="stylesheet">
    </head>
    <body class="">
    <header class="header">
        @if (Route::has('login'))
    ...
    <div class="course-description">
        <div class="first-part-row">
            ...
            <div class="start-stop-btns-group">
                <a href="/courses/coursepresentation/coursesession" class="start-course-btn">Commencer le cours</a>
                <button class="stop-course-btn">Abandonner le cours</button>
                <div class="note-moyenne">4/5</div>
            </div>
        </div>
        
        <div>
            <h3 class="course-presentation-part-title">Résumé</h3>
